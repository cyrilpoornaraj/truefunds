...
import 'particular_created_model.dart';
export 'particular_created_model.dart';

class ParticularCreatedWidget extends StatefulWidget {
  const ParticularCreatedWidget({super.key});

  static String routeName = 'ParticularCreated';
  static String routePath = '/particularCreated';

  @override
  State<ParticularCreatedWidget> createState() =>
      _ParticularCreatedWidgetState();
}

class _ParticularCreatedWidgetState extends State<ParticularCreatedWidget> {
  late ParticularCreatedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ParticularCreatedModel());
  }
